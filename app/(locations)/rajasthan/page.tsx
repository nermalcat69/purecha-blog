...
export const metadata = generatePageMetadata({
  title: "Bulk Chai Supplier in Rajasthan — Jaipur, Jodhpur & More | PurechaChai",
  description: "PurechaChai supplies wholesale bulk chai to heritage hotels, resorts, restaurants, and businesses across Rajasthan. Serving Jaipur, Jodhpur, Udaipur, and more.",
  canonical: "/rajasthan",
  keywords: ["bulk chai rajasthan", "wholesale chai jaipur", "bulk tea supplier rajasthan", "chai supplier jodhpur"],
});
    ...
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-bold tracking-tight mb-3">Rajasthan</h1>
          <p className="text-muted-foreground max-w-2xl leading-relaxed">
            We supply bulk chai to businesses across Rajasthan — from Jaipur's hotel chains and
            tourist establishments to Jodhpur's heritage properties and Udaipur's resort hospitality sector.
            Wholesale pricing available for high-volume buyers across the state.
          </p>
        </div>
          ...
          {cityList.map((city) => (
            ...
            >
              ...
              <div className="flex gap-2 flex-wrap">
                <Link
                  href={`/rajasthan/${slugify(city.city)}`}
                  className="text-xs px-2.5 py-1.5 border rounded-lg hover:bg-muted transition-colors"
                >
                  Details
                </Link>
                <a
                  href={`https://wa.me/${siteMetadata.whatsappNumber}?text=${encodeURIComponent(`Hi, I'd like a bulk chai price quote for ${city.city}, Rajasthan.`)}`}
                  target="_blank"
